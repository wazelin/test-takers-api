...
use Wazelin\TestTakersApi\User\Presentation\Web\Responder\View\Json\UsersJsonView;
...
class UsersResponder
{
    ...
    public function respond(ResponseInterface $response, User ...$users): ResponseInterface
    {
        return $this->responder->respond(
            $response,
            new UsersJsonView(...$users)
        );
    }
}
